...
public class SIVImageViewController<ImageView, LoadingView>: UIViewController where ImageView:SIVImageViewType, LoadingView:SIVImageLoadingIndicatorViewType, ImageView:UIView, LoadingView:UIView {
