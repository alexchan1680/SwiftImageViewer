...
public class SIVImageViewController<ImageView, LoadingView where ImageView:SIVImageViewType, LoadingView:SIVImageLoadingIndicatorViewType, ImageView:UIView, LoadingView:UIView>: UIViewController {
